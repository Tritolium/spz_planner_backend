...
function getEventEvalByUsergroup($usergroup_id)
{
    ...
    $query = "SELECT event_id, type, location, date, plusone AS ev_plusone FROM tblEvents WHERE date >= curdate() AND (state = 0 OR state = 1) AND usergroup_id=:usergroup_id ORDER BY date";
